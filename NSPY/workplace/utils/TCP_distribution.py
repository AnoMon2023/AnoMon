...
def TCP_Distribution(time, lamda):
    ...
    if x <= 15:
        ...
        return time / random.randint(1000000*lamda, 2000000*lamda), 0
    elif x <= 90:
        return time / random.randint(20000000*lamda, 50000000*lamda), 1
    elif x <= 97:
        return time / random.randint(50000000*lamda, 100000000*lamda), 1
    else:
        return time / random.randint(100000000*lamda, 300000000*lamda), 1
